...
class ImageCaptionDataset(Dataset):
    def __init__(self, image_dir, transform=None):
        ...
        self.image_files = [f for f in os.listdir(image_dir) if any(f.lower().endswith(ext) for ext in [".jpg", ".jpeg", ".png", ".bmp", ".gif", ".tiff", ".webp"])]
...
# Create dataset
dataset = ImageCaptionDataset(image_dir=input_dirs, transform=transform)
